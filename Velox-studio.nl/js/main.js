...
// ── HERO TIMELINE (alleen op pagina's met hero) ──
...
// ── ORB PARALLAX (alleen op homepage) ──
...
// ── PROBLEEM / OPLOSSING (alleen op homepage) ──
...
document.querySelectorAll('a[href^="#"]').forEach(anchor => {
    anchor.addEventListener('click', e => {
        ...
        if (target) {
            e.preventDefault();
            const navHeight = nav ? nav.offsetHeight + 12 : 12;
